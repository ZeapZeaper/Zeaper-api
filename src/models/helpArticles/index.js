...
const HelpArticleSchema = new mongoose.Schema({
  ...
  subCategory: {
    type: String,
    required: true,
    enum: helpCenterSubCategoryEnums,
  },
  isPopular: { type: Boolean, default: false },
  helpfulCount: [{ type: mongoose.Schema.Types.ObjectId, ref: "Users" }],
  notHelpfulCount: [{ type: mongoose.Schema.Types.ObjectId, ref: "Users" }],
});
