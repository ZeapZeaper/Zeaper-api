...
let routes = (app) => {
  ...
  router.post("/user/create/googleApple", authMiddleware, upload, userResolver.createUserWithGoogleOrApple);
  ...
  router.delete("/user/delete/absolute", authMiddleware, userResolver.absoluteDeleteUser);
  ...
  router.delete("/shop/delete/absolute", authMiddleware, shopResolver.absoluteDeleteShop);
